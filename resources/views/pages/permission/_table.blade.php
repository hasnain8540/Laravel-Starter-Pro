            ...
            <td class="text-end">
                <a href="#" class="btn btn-sm btn-light btn-primary w-125px" data-kt-menu-trigger="click"
                   data-kt-menu-placement="bottom-end"><i
                    ...
                    <!--end::Svg Icon--></a>
                <!--begin::Menu-->
                <div class="dropdown-menu" data-kt-menu="true">
                    <!--begin::Menu item-->
                    @can('edit permission')
                        <li>
                            <a href="{{ route('permission.edit',['id'=>$l->id]) }}" class="dropdown-item"><i
                ...
                <!--end::Menu item-->
                    ...
                    @can('view permission')
                        <li>
                            <a href="{{ route('permission.view',['id'=>$l->id]) }}" class="dropdown-item"><i
                ...
                <!--end::Menu item-->
                    ...
                    @can('delete permission')
                        <li>
                            <a href="#" class="dropdown-item destroyPermission" data-bs-toggle="modal"
                               data-bs-target="#destroyPermission" data-permissison_id="{{ $l->id }}"
