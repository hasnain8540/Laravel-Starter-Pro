<x-base-layout>
    ...
    @section('headerToolBox')
        <div class="col-5">
            <a href="{{route('permission.index') }}" class=" mx-6 btn btn-sm btn-primary float-end text-nowrap"><i
                    class="fs-4 bi bi-arrow-left"></i>Back</a>
        </div>
@endsection
<!--begin::Card-->
    <div class="card">
        <form method="post" action="{{ route('permission.update',['id'=>$detail->id]) }}" id="kt_form_validate">
        @csrf
        <!-- begin::Card header -->
            <div class="card-header flex-wrap pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">{{ __('Edit Permission') }} </h3>
                </div>
            </div>
            <!-- end::Card Header -->
            <!--begin::Card body-->
