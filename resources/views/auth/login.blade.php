    ...
    <!--begin::Heading-->
        <div class="text-center mb-10">
            ...
            <h1 class="text-dark mb-3">
                {{ __('Sign In to Laravel Starter Pro') }}
            </h1>
            <!--end::Title-->
...
{{--            </div>--}}
        ...
        <div class="mb-10 bg-light-info p-8 rounded"><div class="text-info"> Use account <strong>superadmin@laravel.com</strong> and password <strong>12345678</strong> to continue. </div></div>
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="email" name="email" autocomplete="off" value="{{ old('email', 'superadmin@laravel.com') }}" required autofocus/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="password" name="password" autocomplete="off" value="12345678" required/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
